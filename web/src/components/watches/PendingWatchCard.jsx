...
export default class PendingWatchCard extends React.Component {
  ...
  render() {
    const { item, onEditApplication } = this.props;
          ...
          <div className="flex-column u-width--full u-padding--20">
            <div className="PendingInstall--wrapper flex-column flex1 justifyContent--center">
              <div className="u-textAlign--center pending-text-wrapper">
                <p className="u-fontSize--normal u-color--tundora u-lineHeight--more u-fontWeight--medium">
                  This application is available for you to install. Once you have
                  installed this application, you will be able to deploy it to a
                  cluster.
                </p>
              </div>
            </div>
