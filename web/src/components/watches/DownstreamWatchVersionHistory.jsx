            ...
            {versionHistory?.length > 0 ?
              selectedDiffReleases ?
                <div className="flex">
                  ...
                  <Link to={`/app/${match.params.slug}/diff/${firstSequenceNumber}/${secondSequenceNumber}`} className={`btn primary blue ${checkedReleasesToDiff.length !== 2 && "is-disabled u-pointerEvents--none"}`}>Diff releases</Link>
                </div>
                :
