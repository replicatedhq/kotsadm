...
describe("<WatchSidebarItem> tests", () => {
  const dummyWatch = {
    ...
    metadata:
      '{"applicationType":"helm","sequence":0,"icon":"https://newrelic.com/assets/newrelic/source/NewRelic-logo-square.svg","name":"newrelic-infrastructure","releaseNotes":"[newrelic-infra] Update limits and version (#14454)\\n\\nSigned-off-by: JF Joly \\u003cjoly.pro@gmail.com\\u003e","version":"0.12.0","license":{"id":"","assignee":"","createdAt":"0001-01-01T00:00:00Z","expiresAt":"0001-01-01T00:00:00Z","type":""}}',
    contributors: [
      {
