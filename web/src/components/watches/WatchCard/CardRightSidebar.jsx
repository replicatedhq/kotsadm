          ...
          <div>
            ...
            <div className="flex-column">
              ...
              <p className="u-fontWeight--medium u-fontSize--small u-color--dustyGray u-marginTop--5 u-lineHeight--medium">
                Select the cluster you would like to download your Ship YAML assets
                from.
              </p>
              <div className="u-marginTop--10">
                <Select
                  ...
                  isOptionSelected={option => {
                    option.value === this.state.downloadCluster.value;
                  }}
                />
              </div>
              <div className="u-marginTop--10">
                <button
                  disabled={this.state.downloadCluster.value === ""}
                  onClick={() => this.downloadAssetsForCluster()}
