      ...
      >
        <div className="Modal-body flex flex-column flex1 u-overflow--auto">
          <h2 className="u-fontSize--largest u-color--tuna u-fontWeight--bold u-lineHeight--normal">
            Create a new integration for {appName}
          </h2>
          <p className="u-fontSize--normal u-color--dustyGray u-lineHeight--normal u-marginBottom--20">
            Ship can notify you when updates are available via email, custom webhook url
            or we can even automatically make a PR to your GitHub repository.
          </p>
          <div className="u-flexMobileReflow">
            <div className="integration-type-wrapper flex1">
              <div
                className={`flex flex1 flex-column choose-integration-type alignItems--center ${type ===
                  "email" && "is-active"}`}
                onClick={() => this.handleTypeClick("email")}
              >
                <span className="icon integration-icon-email u-pointerEvents--none u-marginBottom--10 u-marginTop--10"></span>
                <p className="u-fontSize--normal u-color--tuna u-fontWeight--bold u-lineHeight--normal u-marginTop-5 u-marginBottom--10">
                  Send an email
                </p>
              </div>
            </div>
            <div className="integration-type-wrapper flex1">
              <div
                className={`flex flex1 flex-column choose-integration-type alignItems--center ${type ===
                  "webhook" && "is-active"}`}
                onClick={() => this.handleTypeClick("webhook")}
              >
          ...
          <div className="u-textAlign--center u-marginTop--30">
            ...
            >
              Configure {type.length > 1 && Utilities.toTitleCase(type)}
            </button>
          </div>
        </div>
      </Modal>
