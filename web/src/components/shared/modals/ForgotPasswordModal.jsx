    ...
    return this.state.emailSent ? (
      <div>
        <p className="u-fontSize--large u-fontWeight--normal u-color--tuna u-lineHeight--normal u-textAlign--center">
          Check your inbox. If there is an account with the specified address, an email
          will be sent with instructions for resetting the password.
        </p>
      ...
      <div>
        <p className="u-fontWeight--medium u-lineHeight--more u-fontSize--large u-color--tundora u-marginBottom--20">
          Provide your email address and if an account exists, we'll send an email with
          a reset link.
        </p>
