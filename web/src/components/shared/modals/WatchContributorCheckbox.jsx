...
export const WatchContributorCheckbox = ({
  ...
  <div
    data-qa={`Checkbox--${item.login}`}
    className="BoxedCheckbox-wrapper flex-column"
  >
    <div
      className={classNames("BoxedCheckbox flex1 flex", {
    ...
    >
      <div className="flex-column flex-verticalCenter input-wrapper">
        <input
          ...
          value={item.login}
          onChange={e => {
            handleCheckboxChange(item.login, e);
          }}
      ...
      >
        <div className="flex-column flex-verticalCenter specs-icon-wrapper alignItems--center">
          <span
            className="user-photo u-pointerEvents--none"
            style={{ backgroundImage: `url(${item.avatar_url})` }}
          ></span>
        </div>
        <div className="flex-column u-marginLeft--small flex-verticalCenter">
          <span className="u-fontWeight--medium u-color--tuna u-fontSize--normal u-lineHeight--default">
            {item.login}
          </span>
        </div>
      </label>
