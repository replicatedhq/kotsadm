...
class DeleteIntegrationModal extends React.Component {
  ...
  handleDeleteIntegration = (id, isPending) => {
    ...
    this.props
      .deleteNotification(id, isPending)
      .then(() => {
      ...
      >
        <div className="Modal-body flex flex-column flex1 u-overflow--auto">
          ...
          <p className="u-fontSize--normal u-color--dustyGray u-lineHeight--normal u-marginBottom--20">
            Are you sure you want to delete this GitHub integration?
            <span className="u-color--tundora u-fontWeight--bold u-fontSize--normal alignItems--self">
              {" "}
              {integrationToDeletePath}{" "}
            </span>
          </p>
          <div className="Form">
            <div className="flex flex1 u-marginBottom--30">
              <div className="flex flex1 flex-column u-marginRight--10">
                <p className="u-fontSize--normal u-color--dustyGray u-lineHeight--normal">
                  You'll no longer be able to manage this GitHub integration, and it
                  will be removed from this view.
                </p>
              </div>
            </div>
            <div className="flex justifyContent--flexEnd u-marginTop--20">
              <button
                ...
                onClick={toggleDeleteIntegrationModal}
              >
                Cancel
              </button>
              <button
                ...
                onClick={() => {
                  this.handleDeleteIntegration(integrationToDeleteId, isPending);
                }}
              >
