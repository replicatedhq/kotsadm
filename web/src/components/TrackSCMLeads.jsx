...
class TrackSCMLeads extends React.Component {
  ...
  handleNotify = async () => {
    ...
    if (this.ensureValues()) {
      ...
      await this.props
        .trackScmLead(provider, email, otherVal)
        .then(() => this.success())
        ...
        {hasBeenNotified ? (
          <div className="success-wrapper flex1 flex-column justifyContent--center alignItems--center">
            ...
            <p className="u-fontSize--large u-color--tuna u-fontWeight--bold u-lineHeight--normal">
              Thanks! We'll notify you when we support{" "}
              {scmType.value === "other"
                ? otherProvider
                  ? otherProvider
                  : "more SCM providers"
          ...
          <div className="flex1 flex-column justifyContent--center">
            <p className="u-lineHeight--normal u-fontSize--large u-color--doveGray u-fontWeight--medium u-marginBottom--30">
              Interested in accessing Replicated Ship with another SCM provider or
              deploying a private instance on-prem? Sign up to get notified.
            </p>
            <div className="u-flexTabletReflow u-marginBottom--20">
              <div className="component-wrapper flex1">
                <p className="u-fontSize--normal u-color--tuna u-fontWeight--bold u-lineHeight--normal u-marginBottom--10">
                  Deployment type
                </p>
                <div className="flex">
                  <div className="flex flex-auto u-marginRight--30">
                    <input
                      ...
                      value={1}
                      onChange={e => {
                        this.setState({ deploymentType: e.target.value });
                      }}
                    />
                    <label
                      htmlFor="onPrem"
                    ...
                    >
                      <div className="flex-auto flex-column u-width--full">
                        <span className="u-fontWeight--medium u-color--tuna u-fontSize--normal u-lineHeight--normal">
                          On-prem
                        </span>
                      </div>
                    </label>
                ...
                {scmType.value === "other" && (
                  <div>
                    ...
                    <input
                      ...
                      value={otherProvider}
                      onChange={e => {
                        this.setState({ otherProvider: e.target.value });
                      }}
                    />
                  </div>
                )}
            ...
            <div className="u-marginTop--20 flex">
              ...
              {this.state.hasError && (
                <div className="flex-column justifyContent--center">
                  <p className="u-color--chestnut u-fontSize--small u-fontWeight--medium u-marginLeft--10 u-lineHeight--normal">
...
export default compose(
  ...
  graphql(trackScmLead, {
    props: ({ mutate }) => ({
      trackScmLead: (deploymentPreference, emailAddress, scmProvider) =>
        mutate({ variables: { deploymentPreference, emailAddress, scmProvider } })
    })
  })
)(TrackSCMLeads);
