...
class TraditionalAuth extends React.Component {
  ...
  render() {
    ...
    const { email, password, firstName, lastName, authLoading } = this.state;

    return (
      <div className="flex1 flex-column traditional-auth-wrapper">
        <div className="flex1 flex-column">
          {context === "signup" ? (
            <p className="u-lineHeight--normal u-fontSize--large u-color--doveGray u-fontWeight--medium u-marginBottom--20">
              We just need a few pieces of infomation to get your account created.
            </p>
          ) : (
            <p className="u-lineHeight--normal u-fontSize--large u-color--doveGray u-fontWeight--medium u-marginBottom--5">
          ...
          <form onSubmit={e => this.onSubmit(e)}>
            ...
            <div className="flex-column u-marginBottom--10">
              ...
              <div className="component-wrapper flex1">
                ...
                {context === "login" && (
                  <p
                    className="replicated-link u-fontSize--small u-marginTop--10"
            ...
            <div className="u-marginTop--10 flex alignItems--center">
              <button type="submit" className="btn primary" disabled={authLoading}>
                {authLoading
                  ? this.state[context].buttonLoadingText
                  : this.state[context].buttonText}
              </button>
              <Link
                to={context === "signup" ? "/login?ta=1" : "/signup"}
                className="replicated-link u-fontSize--small u-marginLeft--10"
              >
                {this.state[context].secondaryAction}
              </Link>
            </div>
          </form>
        </div>
