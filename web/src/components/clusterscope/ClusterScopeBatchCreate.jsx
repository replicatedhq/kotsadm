...
class ClusterScopeBatchCreate extends React.Component {
  ...
  handleSave = () => {
    ...
    this.props
      .uploadImageWatchBatch(this.state.imageInput)
      .then(result => {
        ...
        this.props.history.replace(
          `/clusterscope/${result.data.uploadImageWatchBatch}`
        );
      })
      .catch(err => {
      ...
      <div className="u-overflow--auto ClusterScopePage--wrapper">
        <div className="Login-wrapper flex1 flex-column alignItems--center justifyContent--center container">
          <div className="ClusterScope-create--wrapper justifyContent--spaceBetween alignItems--center u-textAlign--center flex-column flex1 u-paddingTop--30 u-marginTop--10 u-paddingBottom--30">
            ...
            <p className="u-fontSize--header2 u-marginTop--normal u-fontWeight--bold u-color--tuna u-lineHeight--more">
            ...
            <p className="u-fontSize--large u-color--dustyGray u-fontWeight--medium u-lineHeight--more u-marginTop--small">
              Run the standard <code>kubectl</code> command below to extract your image
              names and SHAs. Submit the output and ClusterScope will analyze each
              3rd-party image and provide a shareable report on how current each version
              is.
            </p>
          </div>
        </div>
        <div className="Output--wrapper container flex-column flex1 container">
          <p className="flex alignItems--center u-fontSize--large u-color--tuna u-fontWeight--bold">
            <span className="step-count">1</span>Run the command
          </p>
  ...
  | sort -u`}
          ...
          <p className="flex u-marginTop--15 alignItems--center u-fontSize--large u-color--tuna u-fontWeight--bold">
            <span className="step-count">2</span>Paste your output
          </p>
          ...
          <div className="flex flex1 u-marginBottom--30">
            <p className="flex u-marginTop--15 alignItems--center u-fontSize--large u-color--tuna u-fontWeight--bold">
              <span className="step-count">3</span>Get a shareable report
            </p>
            <div className="flex-column flex1 justifyContent--flexEnd">
              <div>
                ...
                <div className="flex flex1 justifyContent--flexEnd">
                  ...
                  >
                    {this.state.saving ? "Checking" : "Check your images"}
                  </button>
                </div>
              </div>
            </div>
