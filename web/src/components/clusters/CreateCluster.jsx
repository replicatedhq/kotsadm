    ...
    const options = [
      {
        ...
        uiInfo: {
          ...
          description: [
            <p
              key="s-text"
              className="u-marginTop--10 u-color--dustyGray u-fontSize--small u-fontWeight--medium u-lineHeight--normal"
            >
              Using Weave Flux or ArgoCD to deploy your Kubernetes applications?
            </p>,
            <div key="s-text-link" className="flex alignItems--center">
              <a
                ...
                className="js-preventDefault unforkLink u-marginTop--10 u-fontSize--small u-fontWeight--medium u-color--chateauGreen"
              >
                Learn more about GitOps{" "}
                <span className="arrow icon clickable u-arrow"></span>
              </a>
            </div>
          ]
        }
        ...
        uiInfo: {
          ...
          description: [
            <p
              ...
              className="u-marginTop--10 u-color--dustyGray u-fontSize--small u-fontWeight--medium u-lineHeight--normal"
            >
              Don't have Flux or ArgoCD but want the same functionality? Try ShipOps.
            </p>,
            <div key="s-text-link" className="flex alignItems--center">
              <a
                href=""
                ...
                className="js-preventDefault unforkLink u-marginTop--10 u-fontSize--small u-fontWeight--medium u-color--chateauGreen"
              >
                Learn more about Ship deployments{" "}
                <span className="arrow icon clickable u-arrow"></span>
              </a>
            </div>
          ]
            ...
            <div className="CreateCluster--wrapper flex-auto">
              <div className="flex1 flex-column">
                <p className="u-fontSize--large u-color--tuna u-fontWeight--bold u-lineHeight--normal">
                  What's the name of your cluster?
                </p>
                <p className="u-fontSize--normal u-fontWeight--medium u-color--dustyGray u-lineHeight--normal u-marginBottom--10">
                  Maybe this is Production, or Europe or something descriptive.
                </p>
                <div className="flex flex1">
                  <input
                    ref={this.clusterNameInputRef}
                ...
                {this.state.createClusterErr && (
                  <p className="u-fontSize--small u-fontWeight--medium u-color--chestnut u-marginTop--10">
                    {this.state.createClusterErr.message}
                  </p>
                )}
              </div>

              <div className="flex-column flex1 u-marginTop--30">
                <p className="u-fontSize--large u-color--tuna u-fontWeight--bold u-lineHeight--normal u-marginBottom--10">
                  How do you want to deploy applications to your cluster?
                </p>
                <div className="flex flex1 u-marginTop--normal cluster-deployment-type">
                  {options.map((option, i) => {
                    ...
                    return (
                      <div
                        key={option.value}
                        className={`BoxedCheckbox-wrapper flex1 ${
                          i === 0 ? "u-marginRight--5" : "u-marginLeft--5"
                        }`}
                      >
                        <div
                          ...
                          >
                            <div className="flex-column u-paddingLeft--20">
                              <div className="u-fontWeight--medium u-color--tuna u-fontSize--normal u-marginBottom--small u-lineHeight--normal">
                                <span
                                  className={`icon clusterType ${option.value} u-marginRight--5`}
                                ></span>
              ...
              <div className="flex-auto u-marginTop--30 u-textAlign--center">
                ...
                >
                  {saving ? "Creating cluster" : "Create deployment cluster"}
                </button>
              </div>
            </div>
          )}
