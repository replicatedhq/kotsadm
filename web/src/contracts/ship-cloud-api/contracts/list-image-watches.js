...
export default () => {
  it("lists image batch watches for solo dev", async done => {
    ...
    expect(result.data.imageWatches[0].name).to.equal(
    ...
    expect(result.data.imageWatches[1].name).to.equal(
    ...
    expect(result.data.imageWatches[2].name).to.equal(
      "localhost:32000/ship-cluster-worker:c7d3ee4@sha256:3af0e0a451dbc4c8a6d541e94ebbac59612f1c2fba7fec5a61f7dfc5ed9f343e"
    );
    expect(result.data.imageWatches[2].isPrivate).to.be.true;
    expect(result.data.imageWatches[2].versionDetected).to.equal(
      "c7d3ee4@sha256:3af0e0a451dbc4c8a6d541e94ebbac59612f1c2fba7fec5a61f7dfc5ed9f343e"
    );
        ...
        imageWatches: [
          {
            ...
            versionsBehind: 3,
            path:
              '[{"sort":3,"version":"11.2","date":"2019-04-25T00:27:55.227279355Z"},{"sort":2,"version":"11.1","date":"2019-02-06T08:16:44.722701909Z"},{"sort":1,"version":"11.0","date":"2018-10-18T23:39:51.864511929Z"},{"sort":0,"version":"10.7","date":"2019-04-25T00:28:05.286902175Z"}]'
          },
          {
