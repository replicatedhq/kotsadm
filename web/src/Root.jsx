    ...
    return (
      <Route
        ...
        render={innerProps => {
          ...
          return (
            <Redirect
              to={`/login?next=${this.props.location.pathname}${this.props.location.search}`}
            />
          );
        }}
      />
                ...
                <div className="flex1 flex-column u-overflow--hidden">
                  <Switch>
                    <Route
                      ...
                      path="/"
                      component={() => (
                        <Redirect to={Utilities.isLoggedIn() ? "/watches" : "/login"} />
                      )}
                    />
                    ...
                    <ProtectedRoute
                      path="/clusters"
                      render={props => <Clusters {...props} />}
                    />
                    <ProtectedRoute
                      path="/cluster/create"
                      render={props => <CreateCluster {...props} />}
                    />
                    <ProtectedRoute
                      path="/watches"
                      render={props => (
                    ...
                    />
                    <ProtectedRoute
                      path="/watch/:owner/:slug/history/compare/:org/:repo/:branch/:rootPath/:firstSeqNumber/:secondSeqNumber"
                      component={DiffGitHubReleases}
                    />
                    <ProtectedRoute
                      path="/watch/:owner/:slug/history/compare/:firstSeqNumber/:secondSeqNumber"
                      component={DiffShipReleases}
                    />
                    <ProtectedRoute
                      path="/watch/:owner/:slug/history"
                      component={VersionHistory}
                    />
                    <ProtectedRoute
                      path="/watch/create/init"
                      render={props => (
                        <ShipInitPre
                          {...props}
                          onActiveInitSession={this.handleActiveInitSession}
                    ...
                    <ProtectedRoute
                      ...
                      component={() => (
                        <StateFileViewer
                          ...
                          subText={
                            <span>
                              Paste in the state.json that was generated by Replicated
                              Ship. If you need help finding your state.json file or you
                              have not initialized your app using Replicated Ship,{" "}
                              <a
                                href="https://ship.replicated.com/docs/ship-init/storing-state/"
                                target="_blank"
