...
require (
	...
	github.com/replicatedhq/kots v1.15.3-0.20200508160435-641fc483fd60
	github.com/replicatedhq/kotsadm/operator v0.0.0-20200508000215-470d1b611181 // indirect
